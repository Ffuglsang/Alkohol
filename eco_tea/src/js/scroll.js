(function(){
	...
	window.addEventListener('scroll', throttle(function() {
		elementFromTop(document.querySelectorAll('.content-wrapper'),  'header', 'shrink-header',  50, 'px'); // as top of element hits top of viewport


		}, 100), false);

	window.addEventListener('resize', debounce(function() {
        	elementFromTop(document.querySelectorAll('.content-wrapper'),  'header', 'shrink-header',  50, 'px');
